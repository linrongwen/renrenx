						...
						<div class="biz-div">
							...
							<div class="biz-info-0">
								...
								<div class="biz-div-1">
									...
									<span>
										<em>作者 : </em><a href="#"><?php  if(!empty($_W['setting']['copyright']['smname'])) { ?><?php  echo $_W['setting']['copyright']['smname'];?><?php  } else { ?>微赞<?php  } ?> (<?php  if(!empty($_W['setting']['copyright']['sitehost'])) { ?><?php  echo $_W['setting']['copyright']['sitehost'];?><?php  } else { ?>www.012wz.com<?php  } ?>)</a>
									</span>
								</div>
							</div>
